...
class TestBattleService(TestCase):
    def test_resolve_battle(self):
        ...
        pikachu = AttackerPokemon(
            level=10,
            stat_current=Statistic(hp=100, attack=50, sp_atk=50, defense=50, sp_def=50, speed=50),
            name="pikachu",
            common_attacks=[
        ...
        snorlax = DefenderPokemon(
            level=10,
            stat_current=Statistic(hp=100, attack=10, sp_atk=10, defense=10, sp_def=10, speed=10),
            name="Snorlax",
            common_attacks=[
